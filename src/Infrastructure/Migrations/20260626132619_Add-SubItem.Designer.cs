...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260626132619_Add-SubItem")]
    partial class AddSubItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Todos.TodoSubItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_todo_sub_item");

                    b.HasIndex("TodoItemId")
                        .HasDatabaseName("ix_todo_sub_item_todo_item_id");

                    b.ToTable("todo_sub_item", "public");
                });
            ...
            modelBuilder.Entity("Domain.Todos.TodoSubItem", b =>
                {
                    b.HasOne("Domain.Todos.TodoItem", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_todo_sub_item_todo_items_todo_item_id");
                });
